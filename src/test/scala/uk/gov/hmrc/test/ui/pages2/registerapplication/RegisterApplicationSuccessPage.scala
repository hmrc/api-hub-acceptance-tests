...
class RegisterApplicationSuccessPage extends ApiHubBasePage(pageReadyTest) {
...
object RegisterApplicationSuccessPage {
  ...
  val pageReadyTest: PageReadyTest = TitlePageReadyTest("Register Application Success")
