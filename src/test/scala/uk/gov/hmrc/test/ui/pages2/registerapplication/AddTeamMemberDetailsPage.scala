...
import uk.gov.hmrc.test.ui.pages2.registerapplication.AddTeamMemberDetailsPage._
import uk.gov.hmrc.test.ui.pages2.registerapplication.AddTeamMemberDetailsPage.elements._
import uk.gov.hmrc.test.ui.pages2.{BasePage, ErrorSummary, PageReadyTest, UrlContainingPageReadyTest}
