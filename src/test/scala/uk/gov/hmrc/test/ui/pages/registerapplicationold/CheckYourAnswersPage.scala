...
import uk.gov.hmrc.test.ui.pages.registerapplicationold.CheckYourAnswersPage._
import uk.gov.hmrc.test.ui.pages.registerapplicationold.CheckYourAnswersPage.elements._
