...
class CreateTeamApiProducerConsumerPage extends BasePage[CreateTeamApiProducerConsumerPage](CreateTeamApiProducerConsumerPage.pageReadyTest){
  ...
  def continue(): CreateTeamMembersPage = {
    click(continueButton)
    CreateTeamMembersPage()
  }
}

object CreateTeamApiProducerConsumerPage {

  val pageReadyTest: PageReadyTest = PageReadyTests.apiHubPage.url("team/create-team/team-producer-consumer")

  object elements {
    val isProducerButton: By = By.id("value-2")
    val continueButton: By = By.id("continueButton")
  }

  def apply(): CreateTeamApiProducerConsumerPage = {
